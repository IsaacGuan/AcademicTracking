...
<body>
	Enter details of the course you want to add to the university :
	<br>
	<br>
	<form onsubmit="return validate()" name="courseform" method="post"
		action="CreateCourse">
		Course code : <input type="text" name="code"><br> Course
		name : <input type="text" name="Name"><br> Maximum
		Students Allowed : <input type="text" name="Cap"><br>
		Does it requires PreRequistes ? <select name="EnforcePrerequites"
			id="EnforcePrerequites">
			<option value="true">true</option>
			<option value="false">false</option>
		</select><br> No. of Midterms allowed : <input type="text" name="Midterms"><br>
		No. of assignments allowed : <input type="text" name="assignments"><br>
		Is there any final ? <select name="hasFinal" id="hasFinal">
			<option value="true">true</option>
			<option value="false">false</option>
		</select><br> Does it involve any project ? <select name="project"
			id="project">
			<option value="true">true</option>
			<option value="false">false</option>
		</select> <br>
		<input type="submit" name="create" value="CreateCourse">
