...
<head>
	<meta charset="utf-8" />
	<title>Academic Tracking System | Deregister Course </title>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form method="post" action="DeregisterCourse" class="form-horizontal" name="deregistercourseform" id="deregistercourseform">
									<%
