...
<body>
	...
	<form name="studentform" method="post" action="CreateStudent"
		onsubmit="return validate();">
		Student Number : <input type="text" name="sno"><br>
		Student name : <input type="text" name="Name"><br> Is
		Student full-time ? <select name="isfulltime" id="isfulltime">
