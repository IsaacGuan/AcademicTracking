...
<%
	...
	List<Course> availableCourses = new ArrayList<Course>(University
			.getInstance().Courses());
	List<Course> notavailableCourses = new ArrayList<Course>(
			currentStudent.getSelectedCourses());
	notavailableCourses.addAll(currentStudent.getRegisteredCourses());
	notavailableCourses.addAll(currentStudent.getCompletedCourses());
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Select Course <small>Select a course from the list</small>
						</h3>
						<ul class="breadcrumb">
						    <li>
						        <i class="icon-home"></i>
							...
							<li>
								<a href="javascript:;">Select Course</a>
								<i class="icon-angle-right"></i>
							</li>
						</ul>
					</div>
					...
					<div class="span12">
						...
						<div class="portlet box yellow">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form method="post" action="SelectCourse" class="form-horizontal" name="selectcourseform" id="selectcourseform">
									<%
									...
									<div class="form-actions">
										<button type="submit" name="selectcourse_btn" id="selectcourse_btn" value="SelectCourse" class="btn yellow">Select</button>
									</div>
								</form>
								<!-- END FORM-->
							</div>
