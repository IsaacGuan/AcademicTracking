...
<head>
	<meta charset="utf-8" />
	<title>Academic Tracking System | Cancel Course </title>
			...
			<div class="container-fluid">
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						<a href="#" id="clerkmenu" class="dropdown-toggle" data-toggle="dropdown">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Cancel Course <small>Cancel a course from the list</small>
						</h3>
						<ul class="breadcrumb">
						    <li>
						        <i class="icon-home"></i>
							...
							<li>
								<a href="javascript:;">Cancel Course</a>
								<i class="icon-angle-right"></i>
							</li>
						</ul>
					</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form method="post" action="CancelCourse" class="form-horizontal" name="cancelcourseform" id="cancelcourseform">
									<%
									...
									<div class="form-actions">
										<button type="submit" name="cancelcourse_btn" id="cancelcourse_btn" value="CancelCourse" class="btn blue">Cancel</button>
									</div>
								</form>
								<!-- END FORM-->
							</div>
