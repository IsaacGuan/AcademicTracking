			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Register for Course <small>Register for a course from the list</small>
						</h3>
						<ul class="breadcrumb">
						    <li>
						        <i class="icon-home"></i>
							...
							<li>
								<a href="javascript:;">Register for Course</a>
								<i class="icon-angle-right"></i>
							</li>
						</ul>
					</div>
					...
					<div class="span12">
						...
						<div class="portlet box yellow">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form method="post" action="RegisterForCourse" class="form-horizontal" name="registerforcourseform" id="registerforcourseform">
									<%
									...
									<div class="form-actions">
										<button type="submit" name="registerforcourse_btn" id="registerforcourse_btn" value="RegisterForCourse" class="btn yellow">Register</button>
									</div>
								</form>
								<!-- END FORM-->
							</div>
