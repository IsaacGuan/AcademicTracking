Feature: Use Case Dependencies
  ...
  Scenario Outline: Use case dependencies
    ...
    Examples: 
      | student number 1 | name 1 | student number 2 | name 2 | student number 3 | name 3 | is fulltime(y/n) | title 1          | course code 1 | title 2              | course code 2 | title 3         | course code 3 | title 4            | course code 4 | title 5                      | course code 5 | capsize | enforce prereqs(y/n) | number of midterms | number of assignments | has a final(y/n) | is project course(y/n) |
      |        101075403 | mike   |        101075433 | isaac  |        101075404 | john   | y                | Graphical Models |        115007 | Virtual Environments |        115205 | Fault Tolerance |        115004 | Computer Animation |        115201 | Distributed Operating System |        105102 |      20 | n                    |                  1 |                     3 | y                | n                      |
      |        101075403 | mike   |        101075433 | isaac  |        101075404 | john   | y                | Graphical Models |        115007 | Virtual Environments |        115205 | Fault Tolerance |        115004 | Computer Animation |        115201 | Distributed Operating System |        105102 |      20 | n                    |                  1 |                     3 | y                | y                      |