Feature: Hierarchical Use Cases - Student Take Course
  ...
  Scenario Outline: Student takes course: writes final after doing assignments and midterms
  ...
  Scenario Outline: Student takes project course: writes final after doing assignments, midterms and projects
    Given the university is initialized
    And wait for 2 days
    And the user inputs clerk
    And the clerk logs in with password admin
